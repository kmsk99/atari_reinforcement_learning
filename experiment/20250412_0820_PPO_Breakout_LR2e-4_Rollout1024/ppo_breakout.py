...
LEARNING_RATE = 0.00025     # 학습률: 파라미터 업데이트 크기 결정, 큰 값은 빠른 학습이나 불안정할 수 있음
...
STEPS_PER_UPDATE = 1024     # 업데이트당 스텝 수: 한번의 학습 사이클에 수집할 데이터 양
...
if __name__ == "__main__":
    ...
    experiment_tag = "Breakout_PPO_LR2e-4_Rollout1024d"
