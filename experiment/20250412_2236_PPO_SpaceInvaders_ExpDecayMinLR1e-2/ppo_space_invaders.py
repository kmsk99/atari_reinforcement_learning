...
EXPERIMENT_TAG = "SpaceInvaders_PPO_ExpDecayMinLR1e-2"
...
# 환경 및 모델 파라미터
ENV_ID = "ALE/SpaceInvaders-v5"  # 환경 ID: 학습할 게임 환경
...
def main(render, output_dir, checkpoint_dir, gameplay_dir, plot_filename, csv_filename, use_pretrained=False):
    ...
    if render:
        ...
        for idx in range(10):
            ...
            imageio.mimsave(os.path.join(gameplay_dir, f"SpaceInvaders_game_play_{idx+1}.gif"), frames, fps=30)
